...
urlpatterns = [
    ...
    path('boards/<int:pk>/topics/<int:topic_pk>/',views.PostListView.as_view(), name='topic_posts'),# path('boards/<int:pk>/topics/<int:topic_pk>', views.topic_posts, name='topic_posts'),
